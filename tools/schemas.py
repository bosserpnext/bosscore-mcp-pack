...
def tool_list() -> list[Tool]:
    return [
        ...
        # ── GIT VERSION CONTROL ──────────────────────────────────
        Tool(name="boss_git_commit", description="Git add + commit + push. message: commit message obligatoire.", inputSchema={"type": "object", "properties": {"message": {"type": "string"}}, "required": ["message"]}),
    ]
